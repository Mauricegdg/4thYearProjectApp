...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Syncfusion.Numericupdown.SfNumericTextBox, Syncfusion.SfNumericUpDown.XForms.Android", SfNumericTextBox.class, __md_methods);
	}
	...
	public SfNumericTextBox (android.content.Context p0)
	{
		...
		if (getClass () == SfNumericTextBox.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Numericupdown.SfNumericTextBox, Syncfusion.SfNumericUpDown.XForms.Android", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
	...
	public SfNumericTextBox (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == SfNumericTextBox.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Numericupdown.SfNumericTextBox, Syncfusion.SfNumericUpDown.XForms.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
	...
	public SfNumericTextBox (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == SfNumericTextBox.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Numericupdown.SfNumericTextBox, Syncfusion.SfNumericUpDown.XForms.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}
	...
	public SfNumericTextBox (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3)
	{
		super (p0, p1, p2, p3);
		if (getClass () == SfNumericTextBox.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Numericupdown.SfNumericTextBox, Syncfusion.SfNumericUpDown.XForms.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2, p3 });
	}
