...
public class InputLayoutToggleViewRenderer_GestureListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Syncfusion.XForms.Android.TextInputLayout.InputLayoutToggleViewRenderer+GestureListener, Syncfusion.Core.XForms.Android", InputLayoutToggleViewRenderer_GestureListener.class, __md_methods);
	}
	...
	public InputLayoutToggleViewRenderer_GestureListener (md525515aaea8e1e7b653700744ebd40935.InputLayoutToggleViewRenderer p0)
	{
		super ();
		if (getClass () == InputLayoutToggleViewRenderer_GestureListener.class)
